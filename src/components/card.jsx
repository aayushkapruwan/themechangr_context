export default function Card() {
  return (
    <div className="relative h-[270px] group w-[200px] overflow-hidden rounded-3xl bg-amber-100 dark:bg-slate-400  hover:shadow-xl transition duration-300 hover:shadow-black/60">
      <div className="">
        <img
